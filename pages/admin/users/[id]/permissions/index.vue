<template>
    ...
    <div class="flex justify-between items-center px-5">
        ...
        <button @click="handleOpenModal" type="button"
            ...
            Permissions</button>
        <!-- Hiển thị modal -->
        <Admin-UserPermissionModal :closeModal="closeModal" v-if="isModalOpen" @close="closeModal" />
    </div>
                ...
                <table class="min-w-full divide-y divide-gray-300">
                    <thead>
                        <tr>
                            ...
                            <th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900">Assignment
                            </th>
                        </tr>
                    </thead>
...
const tabs = [
    ...
    { name: 'History', href: `/admin/users/${id}/users`, current: false },
    ...
    { name: 'Permissions', href: `/admin/users/${id}/permissions`, current: true },
