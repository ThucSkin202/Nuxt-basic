...
const tabs = [
    ...
    { name: 'Devices', href: `/admin/roles/${id}/permissions`, current: false },
    { name: 'History', href: `/admin/roles/${id}/users`, current: false },
    { name: 'Raw JSON', href: `/admin/roles/${id}/users`, current: false },
    { name: 'Authenrized Applications', href: `/admin/roles/${id}/users`, current: false },
    { name: 'Permissions', href: `/admin/roles/${id}/users`, current: false },
    { name: 'Roles', href: `/admin/roles/${id}/users`, current: false },
];
